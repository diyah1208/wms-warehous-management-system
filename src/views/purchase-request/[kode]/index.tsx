    ...
    <WithSidebar>
        ...
        <div className="fixed inset-0 z-50 bg-black/40 flex items-center justify-center print:hidden">
          <div className="bg-white p-6 rounded-md w-[350px] space-y-4 text-center">
            ...
            <QRCodeCanvas
              value={`https://wms-warehouse-management-system.vercel.app/pr-sign/${encodeURIComponent(
                pr.pr_kode
              )}`}
              size={200}
              className="mx-auto"
  ...
  <TableRow>
    <TableCell colSpan={6} className="text-center">
     ...
     {pr.signature_url && (
             ...
             <img
  src={`https://wms-warehouse-management-system.vercel.app/storage/${pr.signature_url}`}
  alt="signature"
